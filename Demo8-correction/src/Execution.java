...
import serialization.SerilizationUtils;
...
public class Execution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SerilizationUtils.serialize(p1, "saveGames/p1.data");

        System.out.println("=========================================");
        System.out.println("Loading [saveGames/p1.data] save Game to p2 object");
        Player p2 = (Player) SerilizationUtils.deserialize("saveGames/p1.data");
